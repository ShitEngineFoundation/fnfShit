...
class FlxSprite extends FlxObject
{
	...
	{
		if (frames == null || (clipRect == null && Math.isNaN(_lastClipRect.x)) || (clipRect != null && clipRect.equals(_lastClipRect)))
			return;
	...
	{
		return antialiasing && SaveData.currentSettings.antialias;
	}
